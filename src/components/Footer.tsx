...
const Footer = () => {
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-15">
          ...
          <div className="flex flex-wrap justify-center gap-8 mb-12 animate-fade-in">
            <div className="glass-card px-6 py-4 rounded-xl flex items-center shadow-lg border border-white/20 transition-transform hover:scale-105">
              <svg className="w-8 h-8 text-cyan-500 mr-3" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div className="glass-card px-6 py-4 rounded-xl flex items-center shadow-lg border border-white/20 transition-transform hover:scale-105">
              <svg className="w-8 h-8 text-blue-500 mr-3" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M20.24 12.24a6 6 0 0 0-8.49-8.49L5 10.5V19h8.5z" />
                <line x1="16" y1="8" x2="2" y2="22" />
                <line x1="17.5" y1="15" x2="9" y2="15" />
              </svg>
              <span className="text-white font-semibold text-lg">Creator Friendly</span>
            </div>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-x-8 gap-y-4 mb-10 text-sm">
            ...
            <a href="/pricing" className="text-clipvobe-gray-300 hover:text-white transition-colors">
              Pricing
            </a>
            <a href="/blog" className="text-clipvobe-gray-300 hover:text-white transition-colors">
              Blog
            </a>
            <a href="/privacy" className="text-clipvobe-gray-300 hover:text-white transition-colors">
              Privacy
            </a>
            <a href="/terms" className="text-clipvobe-gray-300 hover:text-white transition-colors">
              Terms
            </a>
          </div>
          ...
          <div className="flex justify-center gap-6 mb-6">
            <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="text-white transition-transform hover:scale-110">
              <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
                <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" />
              </svg>
            </a>
            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-white transition-transform hover:scale-110">
              <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
      ...
      {/* Feature Popup */}
      <FeaturePopup isOpen={featurePopupOpen} onClose={() => setFeaturePopupOpen(false)} />
    </>
  );
};
