...
const VideoCommunityPostGenerator: React.FC<{
  ...
  const [selectedMotive, setSelectedMotive] = useState('New Video Announcement'); // Default motive
  ...
  // Dynamic placeholder based on motive
      ...
      const response = await fetch(
        `https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key=${apiKey}`,
        {
          ...
          body: JSON.stringify({
            ...
            generationConfig: {
              maxOutputTokens: 1000, // YouTube Community post limit
              temperature: 0.7,
            },
          }),
        }
