...
import { X, Tag, FileText, Image, Hash, Video, RefreshCw, Search, Scissors, MessageSquarePlus, User } from 'lucide-react';
...
const FeatureItem = ({ icon, title, description }: FeatureItemProps) => {
  return (
    <div className="glass-card rounded-xl p-5 hover-glow group hover-scale transition-all duration-300">
      ...
      <div className="text-clipvobe-gray-300 text-sm">
        {description}
      </div>
    </div>
  );
  ...
  const features = [
    {
      ...
      description: (
        <>
          <p className="mb-1">🔹 Generate 100+ engaging titles in seconds using AI.</p>
    ...
    },
    {
      ...
      description: (
        <>
          <p className="mb-1">🔹 AI creates SEO-friendly and engaging descriptions.</p>
    ...
    },
    {
      ...
      description: (
        <>
          <p className="mb-1">🔹 Get the best AI-suggested trending hashtags.</p>
    ...
    },
    {
      ...
      description: (
        <>
          <p className="mb-1">🔹 Craft authentic Reddit posts for any subreddit.</p>
    ...
    },
    {
      ...
      description: (
        <>
          <p className="mb-1">🔹 Create professional LinkedIn posts instantly.</p>
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-clipvobe-gray-300">
            Explore our powerful AI tools designed to enhance your content creation workflow
          </p>
        </div>
